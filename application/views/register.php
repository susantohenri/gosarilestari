...
<body class="min-h-screen bg-slate-50 flex items-center justify-center p-4 text-slate-800">
  <div class="w-full max-w-lg">
    <div class="text-center mb-8">
      ...
      <p class="text-sm text-slate-500">Daftar sebagai warga baru</p>
    </div>

    <div class="bg-white rounded-xl border border-slate-100 shadow-sm p-6 md:p-8">
      <h1 class="text-lg font-bold text-slate-800 mb-1">Registrasi</h1>
      <p class="text-sm text-slate-500 mb-6">Lengkapi data di bawah untuk membuat akun warga.</p>
